...
public class NoteCreate {
    ...
    public String toString() {
        ...
        sb.append(NoteCreate.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("date");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NoteCreate) == false) {
            return false;
        }
        NoteCreate rhs = ((NoteCreate) other);
        return (((((((((((((((this.date == rhs.date)||((this.date!= null)&&this.date.equals(rhs.date)))&&((this.headacheType == rhs.headacheType)||((this.headacheType!= null)&&this.headacheType.equals(rhs.headacheType))))&&((this.pressureEveningUp == rhs.pressureEveningUp)||((this.pressureEveningUp!= null)&&this.pressureEveningUp.equals(rhs.pressureEveningUp))))&&((this.medicine == rhs.medicine)||((this.medicine!= null)&&this.medicine.equals(rhs.medicine))))&&((this.triggers == rhs.triggers)||((this.triggers!= null)&&this.triggers.equals(rhs.triggers))))&&((this.duration == rhs.duration)||((this.duration!= null)&&this.duration.equals(rhs.duration))))&&((this.intensity == rhs.intensity)||((this.intensity!= null)&&this.intensity.equals(rhs.intensity))))&&((this.headacheTime == rhs.headacheTime)||((this.headacheTime!= null)&&this.headacheTime.equals(rhs.headacheTime))))&&((this.symptoms == rhs.symptoms)||((this.symptoms!= null)&&this.symptoms.equals(rhs.symptoms))))&&((this.pressureMorningDown == rhs.pressureMorningDown)||((this.pressureMorningDown!= null)&&this.pressureMorningDown.equals(rhs.pressureMorningDown))))&&((this.isHeadache == rhs.isHeadache)||((this.isHeadache!= null)&&this.isHeadache.equals(rhs.isHeadache))))&&((this.comment == rhs.comment)||((this.comment!= null)&&this.comment.equals(rhs.comment))))&&((this.pressureEveningDown == rhs.pressureEveningDown)||((this.pressureEveningDown!= null)&&this.pressureEveningDown.equals(rhs.pressureEveningDown))))&&((this.pressureMorningUp == rhs.pressureMorningUp)||((this.pressureMorningUp!= null)&&this.pressureMorningUp.equals(rhs.pressureMorningUp))));
    }
