...
public class QuestionResponse {
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((this.triggersQuestion == rhs.triggersQuestion)||((this.triggersQuestion!= null)&&this.triggersQuestion.equals(rhs.triggersQuestion)))&&((this.pressureQuestion == rhs.pressureQuestion)||((this.pressureQuestion!= null)&&this.pressureQuestion.equals(rhs.pressureQuestion))))&&((this.userId == rhs.userId)||((this.userId!= null)&&this.userId.equals(rhs.userId))))&&((this.durationQuestion == rhs.durationQuestion)||((this.durationQuestion!= null)&&this.durationQuestion.equals(rhs.durationQuestion))))&&((this.painTypeQuestion == rhs.painTypeQuestion)||((this.painTypeQuestion!= null)&&this.painTypeQuestion.equals(rhs.painTypeQuestion))))&&((this.intensityQuestion == rhs.intensityQuestion)||((this.intensityQuestion!= null)&&this.intensityQuestion.equals(rhs.intensityQuestion))))&&((this.symptomsQuestion == rhs.symptomsQuestion)||((this.symptomsQuestion!= null)&&this.symptomsQuestion.equals(rhs.symptomsQuestion))))&&((this.areaQuestion == rhs.areaQuestion)||((this.areaQuestion!= null)&&this.areaQuestion.equals(rhs.areaQuestion))))&&((this.medicineQuestion == rhs.medicineQuestion)||((this.medicineQuestion!= null)&&this.medicineQuestion.equals(rhs.medicineQuestion))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.commentQuestion == rhs.commentQuestion)||((this.commentQuestion!= null)&&this.commentQuestion.equals(rhs.commentQuestion))))&&((this.timeQuestion == rhs.timeQuestion)||((this.timeQuestion!= null)&&this.timeQuestion.equals(rhs.timeQuestion))));
    }
